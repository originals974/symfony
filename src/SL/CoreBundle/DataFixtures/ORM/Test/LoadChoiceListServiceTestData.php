...
class LoadChoiceListServiceTestData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    /**
    ...
    {   
        ...
        $choiceList = $testService->getChoiceListInstance();
